...
export function SegmentedControl({ options, value, onChange, size = "sm" }: SegmentedControlProps) {
  return (
    <div className={`oc-segmented oc-segmented-${size}`} data-Zeros="segmented">
      {options.map((opt) => (
        <button
          key={opt.value}
...
export function NumberInputWithUnit({
  ...
  return (
    <div className="oc-num-field" data-Zeros="num-input">
      {label && (
        <span
          ref={labelRef}
...
export function SliderInput({
  ...
  return (
    <div className="oc-slider-field" data-Zeros="slider">
      {label && (
        <span
