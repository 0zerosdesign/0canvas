...
import type { AnnotationTool, Annotation } from "../store/store";
  ...
  return (
    <div className="absolute inset-0 z-20 pointer-events-none">
      ...
      <div className="absolute top-3 left-1/2 -translate-x-1/2 z-30 pointer-events-auto">
        <div className="flex items-center gap-1 bg-[var(--grey-900)]/95 backdrop-blur-sm border border-[var(--grey-800)] rounded-xl px-2 py-1.5 shadow-2xl">
          {/* Tools */}
          {TOOLS.map((t) => (
            <button
              key={t.id}
              ...
              className={`p-1.5 rounded-lg transition-colors ${
                tool === t.id
                  ? "bg-[var(--blue-600)]/15 text-[var(--blue-600)]"
                  : "text-muted-foreground hover:text-foreground hover:bg-[var(--grey-800)]"
              }`}
          ...
          <div className="w-px h-5 bg-[var(--grey-800)] mx-1" />
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-[var(--grey-800)] transition-colors"
            title="Undo last"
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-muted-foreground hover:text-[var(--red-500)] hover:bg-[var(--red-500)]/10 transition-colors disabled:opacity-30"
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-[var(--grey-800)] transition-colors ml-0.5"
      ...
      {textPosition && (
        ...
        >
          <div className="flex items-center gap-1 bg-[var(--grey-900)] border border-[var(--grey-700)] rounded-lg shadow-xl overflow-hidden">
            <input
              type="text"
              autoFocus
              value={textInput}
            ...
            <button
              ...
              className="px-2 py-1.5 text-[var(--blue-600)] hover:bg-[var(--blue-600)]/10 transition-colors"
            >
